...
| 抖音 | 创作者中心 → 数据中心 → **作品数据/内容分析的按作品列表**（"数据表现"导出是周期汇总，不对）| ⚠️ 按作品导出入口待确认 |
| 视频号 | 视频号助手——"视频详情数据"是按天汇总 | ⚠️ 疑似无批量按作品导出，备选：浏览器读数或手动 record |
...
- **抖音/视频号按作品数据**：尚未回灌。下一步：抖音确认按作品导出入口；视频号大概率走浏览器读数（Claude in Chrome 预演 v1 主通道）或手动 record。
